...
class App extends Component {
  ...
  findPlaceDetail = (placeIdFound) => {
    var request = {
      ...
      fields: ['rating','reviews','opening_hours', 'address_component', 'adr_address', 'alt_id', 'formatted_address',
          ...
          {this.state.places &&
            <div className='row'>
              <div className="col-12">
                <button className="btn btn-primary text-center" onClick={this.getNearbyPlacesOnClick}>Buscar lugares cercanos</button>
              </div>
            </div>
          }
